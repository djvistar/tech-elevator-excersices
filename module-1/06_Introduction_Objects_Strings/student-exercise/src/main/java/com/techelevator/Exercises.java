...
public class Exercises {
	...
	public String makeTags(String tag, String word) {
		 String openningTag = "<"+tag+">"; 
         String closingTag = "</"+tag+">";
         String str= openningTag + word + closingTag;
         return str;
	...
	public String makeOutWord(String out, String word) {
		      ...
		      String str = out.substring( 0, 2 ) + word
		           + out.substring( 2, 4 );
		      return str;
		    }
	...
	//using Regex. the w checks for any xter before xx and w* checks for any xter after the xx
		
		if (str.matches("(\\w)?(xx)\\w*")){
			return true;
		}
