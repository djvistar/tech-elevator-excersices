<template>
  <div class="container">
    ...
    <div class="all-actions">
      <button v-on:click="enableSelectedUsers()" 
      v-bind:disabled="actionButtonDisabled">Enable Users</button>
      <button v-on:click="disableSelectedUsers()"
       v-bind:disabled="actionButtonDisabled">Disable Users</button>
      <button v-on:click="deleteSelectedUsers()"
       v-bind:disabled="actionButtonDisabled">Delete Users</button>
    </div>
